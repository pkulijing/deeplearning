...
\begin{empheq}[left=\empheqlbrace]{align*}
\frac{\partial J}{\partial \mathbf{Z}^{[l]}}&=\begin{cases}
W^{[l+1]\mathsf{T}}\frac{\partial J}{\partial \mathbf{Z}^{[l+1]}}*g^{[l]\prime}(\mathbf{Z}^{[l]}) &l<n\\
\mathbf{A}^{[n]}-\mathbf{Y} &l=n\\
\end{cases}\\
\frac{\partial J}{\partial \mathbf{W}^{[l]}}&=\frac{1}{m}\frac{\partial J}{\partial \mathbf{Z}^{[l]}}\mathbf{A}^{[l-1]\mathsf{T}}\\
\frac{\partial J}{\partial \mathbf{b}^{[l]}}&=\frac{1}{m}np.sum(\frac{\partial J}{\partial \mathbf{Z}^{[l]}}, axis=1)
\end{empheq}
