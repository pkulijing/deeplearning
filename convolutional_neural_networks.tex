...
in which $p_c$ denotes whether there exists an object in the image, $(b_x, b_y)$ is the center of the bounding box, $b_h, b_w$ is the height and width of the bounding box, and $c_i$ is the the normal softmax output for class $i$.
\ifx\PREAMBLE\undefined
\end{document}
\fi